                    ...
                    try (Connection conn = DatabaseConnection.getConnection()) {
                        if (conn != null) {
                            ...
                            if (hasConflict) {
                                ...
                                String insertSql = "INSERT INTO Reservations (reservation_number, guest_name, address, contact_number, room_type, check_in_date, check_out_date, total_cost) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
                                try (PreparedStatement pstmt = conn.prepareStatement(insertSql)) {
                                    ...
                                    pstmt.setString(7, checkOutDateStr);
